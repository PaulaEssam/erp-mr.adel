...
if (isset($_POST['delete'])) {
        ...
        $delete_kataket = $conn->prepare("DELETE FROM `medcine` WHERE name=?");
    ...
    <!-- <div class="box-container">
        ...
        <div class="box">
            <table id="studentTable" class="studentsTable">
                ...
                <?php
                    $i=1;
                        $select_medcine = $conn->prepare("SELECT * FROM `medcine`");
                        $select_medcine->execute();
...
<section class="dashboard">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="flex">
                <a href="medcine.php?u_name=<?=$fetch_user['user_name'];?>" class="btn" style="width: 30%;">اضافة</a>
                <a href="medcine_table.php?u_name=<?=$fetch_user['user_name'];?>" class="option-btn" style="width: 30%;">عرض</a>
                <form action="" method="post">
