...
if (isset($_POST['delete'])) {
    ...
    $delete_food = $conn->prepare("DELETE FROM `food` WHERE name=?");
    $delete_food->execute([$userName]);
        ...
        <div class="box">
            <table id="studentTable" class="studentsTable">
                ...
                <tbody>
                    <?php
                    $i=1;
                        $select_food = $conn->prepare("SELECT * FROM `food`");
                        $select_food->execute();
                    ...
                    <tr>
                        ...
                        <td ><a href="edit_food.php?k_id=<?=$fetch_food['id']?>" class="option-btn">تعديل</a></td>
...
<section class="dashboard">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="flex">
                <a href="food.php?u_name=<?=$fetch_user['user_name'];?>" class="btn" style="width: 30%;">اضافة</a>
                <a href="food_table.php?u_name=<?=$fetch_user['user_name'];?>" class="option-btn" style="width: 30%;">عرض</a>
                <form action="" method="post">
